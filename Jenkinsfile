...
"""
    ...
    parameters {
        string(name: 'IMAGE_NAME', defaultValue: 'nicknema13/express-fe', description: 'Your image name in format USER_NAME/IMAGE. You can write it as default value if you want')
    }
